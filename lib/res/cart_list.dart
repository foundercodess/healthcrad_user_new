...
class CartListViewState extends State<CartListView> {
  ...
  Widget build(BuildContext context) {
    ...
    return cartViewModel.vModelData ==null?const Center(child: CircularProgressIndicator()): ListView.builder(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        TextConst(
                          title: cartViewModel.vModelData?.viewCartData?[index].name,
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                  ...
                                  children: [
                                    CustomRichText(textSpans: [
                                      ...
                                      CustomTextSpan(
                                          ...
                                          text: "₹ ${cartViewModel.vModelData!.viewCartData?[index].price}",
                                    ...
                                    CustomRichText(textSpans: [
                                      ...
                                      //     fontSize: AppConstant.fontSizeOne),
                                      CustomTextSpan(
                                          text: "${cartViewModel.vModelData!.viewCartData?[index].discount} % off",
                                ...
                                AppConstant.spaceHeight5,
                                TextConst(
                                  title: cartViewModel.vModelData!.viewCartData?[index].discountedAmount.toString(),
                                  fontWeight: FontWeight.bold,
                                  fontSize: AppConstant.fontSizeTwo,
                                  color: AppColor.blackColor,
                                ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        TextConst(
                          title: cartViewModel.vModelData!.viewCartData?[index].productQuantity,
